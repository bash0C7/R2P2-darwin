MRuby::Gem::Specification.new('picoruby-iphone-torch') do |spec|
  ...
  # `require "torch"` in app.rb resolves to this gem (picoruby-require looks the
  # name up in prebuilt_gems; without this it would be "iphone-torch").
  spec.require_name = 'torch'
